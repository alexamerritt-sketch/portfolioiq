...
function calcMetrics(holdings) {
  ...
  // Based on: number of sectors (max 40pts), top sector concentration (max 40pts), number of holdings (max 20pts)
...
export default function App() {
  ...
  function handleAnalyze() {
    setMetrics(calcMetrics(holdings));
    setAnalyzed(true);
  }
  ...
  return (
    <>
<div style={{ background: "linear-gradient(135deg, #b8933a, #d4a84b)", padding: "12px 24px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", flexWrap: "wrap" }}>
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-danger { background: transparent; color: #f87171; border: none; cursor: pointer; font-size: 18px; padding: 2px 6px; border-radius: 4px; transition: background 0.15s; line-height: 1; }
      ...
      <div style={{ borderBottom: "1px solid #0f172a", padding: "28px 0 22px", background: "#020817" }}>
        <div style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 22, fontWeight: 500, color: "#e2e8f0" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "32px 24px 0" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ background: "#0b1120", border: "1px solid #1e293b", borderRadius: 12, overflow: "hidden" }}>
            ...
            {holdings.length === 0 && (
              <div style={{ padding: "32px", textAlign: "center", color: "#334155", fontSize: 14 }}>No holdings yet. Add one above.</div>
            )}
            {holdings.map((h, i) => (
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <button className="btn-primary" style={{ padding: "14px 40px", fontSize: 15, borderRadius: 10 }} onClick={handleAnalyze} disabled={holdings.length === 0}>
            Analyze Portfolio →
          </button>
        </div>
